...
export default function Student() {
  function _handleSubmit(e) {
    ...
    console.log(data);
    $.ajax({
      url: 'http://127.0.0.1:8080/EtiqaSchool/createNewStudent',
      headers: {
      ...
      success: function (result) {
        ...
        $('#alert').text("Student create with Id : " + result.id);
      }
      , error: function () {
        $('#alert_div').show();
  ...
  return (<>
    <form id="student_create_form" onSubmit={_handleSubmit} className="row g-3 mx-auto">
